      ...
      <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a href="/JagrutiResume.pdf" target="_blank" className="px-8 py-4 border border-white/10 text-white font-black uppercase text-xs tracking-widest hover:border-violet-500 hover:text-violet-400 transition-all">
              Resume.manifest
            </a>
          </div>
